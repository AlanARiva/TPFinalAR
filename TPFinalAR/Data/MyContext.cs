    ...
    public class MyContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UsuarioCajaDeAhorro>().HasData(
                        new { id_caja = 1, id_usuario = 1 },
                        new { id_caja = 2, id_usuario = 2 },
                        new { id_caja = 3, id_usuario = 3 },
                        new { id_caja = 4, id_usuario = 4 },
                        new { id_caja = 5, id_usuario = 1 },
                        new { id_caja = 6, id_usuario = 1 });
        ...
        public DbSet<TPFinalAR.Models.PlazoFijo> PlazoFijo { get; set; } = default!;

        public DbSet<TPFinalAR.Models.UsuarioCajaDeAhorro> UsuarioCajaDeAhorro { get; set; } = default!;
